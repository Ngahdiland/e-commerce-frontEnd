    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
          ...
          <p className="mt-5 text-gray-500 md:w4/5">
          ...
          <div className="text-sm text-gray-500 mt-5 flex flex-col gap-1">
            ...
            <p className="">Cash on delevery available for this product.</p>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 text-sm text-gray-500">
          <p className="">
            ...
            expedita rem consectetur doloremque veniam iste amet mollitia
            numquam molestiae alias eveniet, recusandae adipisci ipsum. Lorem
            ipsum, dolor sit amet consectetur adipisicing elit. Rerum, esse.
          </p>
          <p className="">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum eaque
            quae a velit consequatur et error repellendus repudiandae dolorum
            reprehenderit.
          </p>
        </div>
      </div>
